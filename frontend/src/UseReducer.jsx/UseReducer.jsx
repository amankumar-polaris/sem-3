  ...
  return (
    <div className="mt-12 text-center">
      ...
      <div className="w-32 bg-gray-900 p-5 mx-auto mt-5 rounded-2xl">
        <div className="w-[70px] h-[70px] rounded-full mx-auto my-2  bg-red-500" />

        <div
          className={"w-[70px] h-[70px] rounded-full mx-auto my-2 bg-yellow-500"}
        />

        <div
          className={"w-[70px] h-[70px] rounded-full mx-auto my-2 bg-green-500"}
        />
      </div>
